    ...
    <footer id="footer">
        ...
        <ul className="icons">
            ...
            <ul className="copyright">
                <li>&copy; Victor Ollervidez</li><li>Built With: <a href="https://www.gatsbyjs.org/" target="_blank">GatsbyJS</a></li><li>Deployed on <a href="https://www.netlify.com/">Netlify</a></li>
            </ul>
        </div>
    </footer>
)
