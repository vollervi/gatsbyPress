...
import pic2 from '../assets/images/pharr-tx-site.png'
            ...
            <section id="one">
                <div className="inner">
                    {/* <header className="major"> */}
                        <h1>City of Pharr Texas</h1>
                    {/* </header> */}
                    <hr className="major" />
                    <div className="grid-wrapper">
                        <div className="col-4">
                        <span className="image fit"><img src={pic2} alt="" /></span>
                        ...
                        <article>
                            <h4>Project Summary</h4>
                                ...
                                <ul className="alt">
                                    ...
                                    <li><b>Tech Used:</b> WordPress, PHP, HTML, CSS, JavaScript, JQuery, Cloudflare</li>
